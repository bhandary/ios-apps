...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var twoWeekTasks = [
        Task(name: "Run test on security alarm", type: .TwoWeeks, completed: true, lastCompleted: nil),
    ...
    @IBAction func resetList(sender: AnyObject) {
        ...
        let noAction = UIAlertAction(title: "Yes", style: .Destructive, handler: {
            action in
